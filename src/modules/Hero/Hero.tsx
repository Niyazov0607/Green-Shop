...
const Hero: React.FC = () => {
    ...
    return (
        <div className="relative w-[1290px] m-auto mt-[15px]">
                    ...
                    >
                        <div className="flex items-center justify-between w-full max-w-[1290px] m-auto">
                            ...
                            <div className="flex flex-col justify-center flex-1">
                                ...
                                <button className="mt-6 px-6 py-2 max-w-40 text-sm font-semibold uppercase bg-[#46A358] hover:bg-[#46A358]/70 text-white rounded-md cursor-pointer">
                                    {slide.btn}
                                </button>
                            </div>
            ...
            {/* Custom Dots */}
            <div className="absolute flex items-center justify-center gap-2 -translate-x-1/2 bottom-4 left-1/2">
                {slides.map((_, index) => (
                    <div
                        key={index}
